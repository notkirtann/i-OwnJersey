...
const ProductItem = ({id,image,name,price}) => {
  ...
  return (
    <Link className='cursor-pointer flex flex-col gap-3 group' to={`/product/${id}`}>
      <div className='overflow-hidden w-full h-84 bg-gray-100 border-2 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-[8px_8px_0px_0px_rgba(220,38,38,1)] hover:border-red-400 transition-all duration-300'>
